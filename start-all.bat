...
:: Kill any existing processes on ports 8000, 8081, 8082
...
start "Python Backend" cmd /k "cd /d %~dp0Backend && python -m uvicorn main:app --reload --host 127.0.0.1 --port 8000"
